  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full md:w-[65vw] md:h-[70dvh] md:mt-30 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-5 md:justify-items-stretch  md:items-center overflow-x-scroll md:overflow-auto scroll whitespace-nowrap scroll-smooth px-4 snap-x md:snap-none no-scrollbar mt-20">
          <div className="ml-15 md:m-0 snap-center w-full md:w-auto rounded-3xl whitespace-normal card_ inline-block m-2  no-scrollbar">
            ...
            <p className="text-pretty text-text  md:h-auto h-[calc(100%-70px)] overflow-y-scroll no-scrollbar">
              <span className="block italic text-[1rem] text-accent">
                2020 – 2024
              </span>
              ...
              <br />
              <span className="block italic mt-2 md:mt-3 text-[1rem] text-accent">
                2014 – 2016
              </span>
          ...
          <div className="md:m-0 snap-center w-full md:w-auto rounded-3xl whitespace-normal card_ inline-block m-2  no-scrollbar">
            <h3 className="font-semibold text-2xl text-accent pb-3">
