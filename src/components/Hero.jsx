  ...
  return (
    <>
      <div
        ...
        id="about"
      >
        <div className="relative flex flex-col pt-10 md:flex-row-reverse items-center md:justify-around justify-center md:gap-10 gap-8 content-between max-w-[1250px] mx-auto h-screen">
          <div>
            <img
              src={ProfilePic}
              alt="shahrokh"
          ...
          <div className="glassmorphism transition duration-500 ">
            <div className="max-w-[80vw] md:max-w-[600px] opacity-100 md:p-3 p-1">
              ...
              <p className="text-text text-justify tracking-normal text-base/6 md:text-[1.2rem] text-[1.1rem] cursor-default">
